...
class YjsSpider(scrapy.Spider):
    ...
    def pars_other(self,response):
        ...
        item_loader.add_xpath("position_title", "//div[contains(@class,'info clearfix')]/ol/li[text()='职位：']/u/text()")
        item_loader.add_xpath("location", "//div[contains(@class,'info clearfix')]/ol/li[text()='工作地点：']/u/text()")
